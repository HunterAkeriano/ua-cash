...
// euro
const eurBuy = document.getElementById('eur-buy');
const eurSale = document.getElementById('eur-sale');
...
fetch(url)
  ...
  .then(data => {
    ...
    eurBuy.textContent = purchaseRateEur;
    eurSale.textContent = saleRateEur;
  })
