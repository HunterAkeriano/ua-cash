...
// Определяем функцию, которая преобразует введенное значение в номер телефона с операторным кодом
...
input.addEventListener('input', (event) => {
  ...
  // Преобразуем введенное значение в номер телефона с операторным кодом
